<div class="card" style="padding: 50px; width: 40%; margin: 0 auto; margin-top: 10%;">
	<center>
		<img src="img/logo_alamraya.png" width="100">
	</center>
	<h6 style="text-align: center;" class="green-text">Login Customer Complaint</h6>
...
if (isset($_POST['login'])) {
	...
	$sql = mysqli_query($koneksi, "SELECT * FROM customer WHERE username='$username' AND password='$password' ");
	...
	if ($cek > 0) {
		...
		echo "<script>alert('Gagal Login! Silahkan masukkan Username dan Password yang benar')</script>";
	}
}
?>