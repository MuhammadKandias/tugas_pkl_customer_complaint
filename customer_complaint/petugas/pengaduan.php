        ...
        <table id="example" class="display responsive-table" style="width:100%">
        	...
        	<tbody>
        		...
        		<?php
				$no = 1;
				$query = mysqli_query($koneksi, "SELECT * FROM pengaduan INNER JOIN customer ON pengaduan.id_customer=customer.id_customer WHERE pengaduan.status='proses' ORDER BY pengaduan.id_pengaduan DESC");
