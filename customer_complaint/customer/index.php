...
<head>
  <title>Customer Complaint Alamraya</title>
  ...
  <script type="text/javascript">
    window.$crisp = [];
    window.CRISP_WEBSITE_ID = "6e48aeb2-1b88-4f76-b51a-cf0a943e1dc4";
    (function() {
      d = document;
      ...
      <ul id="slide-out" class="sidenav sidenav-fixed">
        <li>
          <div class="user-view">
            ...
            <a href="#user"><img class="circle" src="https://w7.pngwing.com/pngs/304/275/png-transparent-user-profile-computer-icons-profile-miscellaneous-logo-monochrome.png"></a>
            <a href="#name"><span class="blue-text name"><?php echo ucwords($_SESSION['data']['nama']); ?> </a>
