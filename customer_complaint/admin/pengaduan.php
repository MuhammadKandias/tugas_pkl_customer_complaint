        ...
        <table id="example" class="display responsive-table" style="width:100%">
        	...
        	<tbody>
        		...
        		<?php
				$no = 1;
				$query = mysqli_query($koneksi, "SELECT * FROM pengaduan INNER JOIN customer ON pengaduan.id_customer=customer.id_customer ORDER BY pengaduan.id_pengaduan DESC");
        				...
        				<div id="more?id_pengaduan=<?php echo $r['id_pengaduan'] ?>" class="modal">
        					<div class="modal-content">
        						...
        						<div class="col s12 m6">
									...
									?>
        							<br><b>Project</b>
        							<p><?php echo $r['project']; ?></p>
        							<br><b>Fitur</b>
        							<p><?php echo $r['fitur']; ?></p>
        							<br><b>Sub Fitur</b>
        							<p><?php echo $r['subfitur']; ?></p>
        							<br><b>Pesan</b>
