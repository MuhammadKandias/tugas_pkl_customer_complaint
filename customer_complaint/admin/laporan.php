        ...
        <table id="example" class="display responsive-table" style="width:100%">
        	...
        	<tbody>
        		...
        		<?php
				$no = 1;
				$query = mysqli_query($koneksi, "SELECT * FROM pengaduan INNER JOIN customer ON pengaduan.id_customer=customer.id_customer INNER JOIN tanggapan ON tanggapan.id_pengaduan=pengaduan.id_pengaduan INNER JOIN petugas ON tanggapan.id_petugas=petugas.id_petugas ORDER BY tgl_pengaduan DESC");
