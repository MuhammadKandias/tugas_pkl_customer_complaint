        	...
        	<tbody>
				...
				while ($r = mysqli_fetch_assoc($tampil)) { ?>
        			<tr>
        				...
        				<td><?php echo $r['telepon_petugas']; ?></td>
        				...
        				<div id="user_edit<?php echo $r['id_petugas'] ?>" class="modal">
        					<div class="modal-content">
        						...
        						<form method="POST">
        							...
        							<div class="col s12 input-field">
        								<label for="telepon_petugas">Telepon</label>
        								<input id="telepon_petugas" type="number" name="telepon_petugas" value="<?php echo $r['telepon_petugas']; ?>"><br><br>
        							</div>
        							<div class="col s12 input-field">
        								<p>
        									<label>
								...
								if (isset($_POST['Update'])) {
									// echo $_POST['nama'].$_POST['username'].$_POST['telepon_petugas'].$_POST['level'];
									$update = mysqli_query($koneksi, "UPDATE petugas SET nama_petugas='" . $_POST['nama'] . "',username='" . $_POST['username'] . "',telepon_petugas='" . $_POST['telepon_petugas'] . "',level='" . $_POST['level'] . "' WHERE id_petugas='" . $_POST['id_petugas'] . "' ");
									if ($update) {
        ...
        <div id="modal1" class="modal">
        	<div class="modal-content">
        		...
        		<form method="POST">
        			...
        			<div class="col s12 input-field">
        				<label for="telepon_petugas">Telepon</label>
        				<input id="telepon_petugas" type="number" name="telepon_petugas"><br><br>
        			</div>
				...
				if (isset($_POST['input'])) {
					...
					$query = mysqli_query($koneksi, "INSERT INTO petugas VALUES (NULL,'" . $_POST['nama'] . "','" . $_POST['username'] . "','" . $password . "','" . $_POST['telepon_petugas'] . "','" . $_POST['level'] . "')");
					if ($query) {
